...
Clostridium difficile toxins A and B (TcdA and TcdB), homologous 
proteins essential for C. difficile infection, affect the behavior 
...
changes of multiple cell types to C. difficile toxins with high 
...
Clostridium difficile infections, with an annual occurrence in the 
US of over 300,000, cause potentially fatal diarrhea and colitis [1]. 
...
epithelial cells to round and detach [2]. Neutrophil infiltration 
and activation of other immune cells, driven by inflammatory 
signals, are also key to toxin-induced enteritis [3]. Though 
...
of each cell type involved [4, 5]. To explore the toxins' 
effects on different cells, facets of the host response have 
been studied using cell lines treated with TcdA and/or TcdB 
(e.g., release of cytokines [4, 6, 7], changes in cell 
morphology [8, 9], gene expression [10, 11], and cell death [12, 13]). 
...
the surface of a cell culture [14-16]. When cells 
...
37\textdegree{}C/5\% CO2. In our analyses, we include 
...
33\textdegree{}C as described by Becker et al. [16, 19]. 
...
all wells to prevent evaporation. In each well, 100 \textmu{}L 
media was incubated at room temperature for 30 minutes, 
and one baseline reading was taken. Cells in 100 \textmu{}L 
media were then added and allowed to settle at room 
temperature for 30 minutes. Plates were then moved inside 
the RTCA DP Analyzer inside a CO2 incubator at 37\textdegree{}C. 
...
have been generated before [20], and we found that our 
...
for infection [24, 25]. Since most cytotoxicity assays 
...
Since TcdA (2.65 \textmu{}g/ml) has been found to enter 
HT29 cells in 5-10 minutes, the delay we observed is likely 
because toxins must enter HCT8 cells to alter their morphology [26].Epithelial and endothelial cell lines had the same 
...
ultrasensitive assay of toxin activity [14]. T84 cells, 
the least sensitive to TcdB, were similarly sensitive to 
TcdA and TcdB, as has been found previously [27]. For 
...
models [16, 28]; and there are varying results about which 
toxin is essential for C. difficile infection [29, 30]. 
...
ceca, damaging the epithelial barrier [16, 31]. This 
agrees with findings that TcdB binds weakly in the hamster 
intestine, and TcdA binds epithelial cells [32, 33]. 
...
and releasing molecules that exacerbate inflammation [22, 34]. 
Previous studies have quantified the viability either TcdA- 
or TcdB-treated macrophages at one or two time points [21, 23, 35]. 
...
of primary mouse macrophages (1 ug/ml at 24h) [23]. The 
...
(1\textmu{}g/ml at 3h and 24h) [21]. This arborization 
...
independent of glucosyltransferase activity [37]? We found 
...
cytotoxic to HeLa cells after only 2.5h [18]. The different 
...
cell rounding [38, 39]. Hence, at the point of cell 
...
greater than 1 \textmu{}g/ml [33]. Assessing sensitivities 
...
(e.g., mast cells [48-50], dendritic cells[51, 52], 
neurons [53, 54], fibroblasts [55, 56], etc.) have been 
